...
param_det_t	     			billing_param_det[128] = {
...
uint8_t						g_raw_data_buff[9*1024];
...
********************************************************************************************************/
int32_t get_gen_scalar_val(uint8_t comm_fd, uint32_t dlms_met_addr, uint8_t met_addr_size, uint8_t recv_qry_type, uint16_t int_class, uint8_t*obis_code, uint8_t obis_len, uint16_t attr_no)
{
	...
	if(send_get_request(comm_fd, dlms_met_addr, met_addr_size, int_class, obis_code, obis_len, attr_no)<0)
	{
	...
	while(g_rr_frame || g_get_nxt_blk)
	{
		...
		while(g_rr_frame)
		{
			if(send_rr_frame(comm_fd, dlms_met_addr, met_addr_size)<0)
			{
		...
		if(temp_nxt_blk_flag)
		{
			...
			if(send_get_next_blk(comm_fd, dlms_met_addr, met_addr_size, *g_block_num_det)<0)
			{
...
********************************************************************************************************/
int32_t get_num_bill_entries(uint8_t comm_fd, uint32_t dlms_met_addr, uint8_t met_addr_size)
{
	...
	if(send_get_request(comm_fd,dlms_met_addr,met_addr_size, BILL_ENTRY_INT_CLASS, obis, 6, BILL_ENTRY_ARR_NO)<0)
	{
...
int32_t get_bill_data_info(meter_comm_params_t *meter_comm_params)
{
	...
	if(get_num_bill_entries(comm_fd, dlms_met_addr, met_addr_size)<0)
	{
	...
	if(send_get_bill_request(comm_fd, dlms_met_addr, met_addr_size,BILL_DATA_INT_CLASS, obis, 6, BILL_DATA_ATTR_NO)<0)
	{
...
int32_t store_bill_date_time(uint8_t bill_index, uint8_t index)
{
	...
	for(bill_dt_idx=0; bill_dt_idx<gen_bill_param_det.tot_num_val_obis; bill_dt_idx++)
	{
		if((index==0)&&(bill_dt_idx==0))
		{
			...
			print_data(billing_param_det[bill_dt_idx].obis_code,6);
		}
		
		if( (memcmp(gen_bill_param_det.val_obis[index], billing_param_det[bill_dt_idx].obis_code,6)) == 0)
		{
			...
			if( (memcmp(billing_param_det[bill_dt_idx].param_name,"date_time",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.date_time,&loc_date_time,sizeof(date_time_t));
			} 
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kwmd",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kwmd_date_time,&loc_date_time,sizeof(date_time_t));
			}
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kwmd_tz1",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kwmd_tz1_date_time,&loc_date_time,sizeof(date_time_t));
			}
			
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kwmd_tz2",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kwmd_tz2_date_time,&loc_date_time,sizeof(date_time_t));
			}
			
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kwmd_tz3",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kwmd_tz3_date_time,&loc_date_time,sizeof(date_time_t));
			}
			
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kwmd_tz4",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kwmd_tz4_date_time,&loc_date_time,sizeof(date_time_t));
			}
			
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kwmd_tz5",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kwmd_tz5_date_time,&loc_date_time,sizeof(date_time_t));
			}
			
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kwmd_tz6",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kwmd_tz6_date_time,&loc_date_time,sizeof(date_time_t));
			}
			
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kwmd_tz7",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kwmd_tz7_date_time,&loc_date_time,sizeof(date_time_t));
			}
			
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kwmd_tz8",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kwmd_tz8_date_time,&loc_date_time,sizeof(date_time_t));
			}
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kvamd",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kvamd_date_time,&loc_date_time,sizeof(date_time_t));
			}
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kvamd_tz1",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kvamd_tz1_date_time,&loc_date_time,sizeof(date_time_t));
			}
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kvamd_tz2",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kvamd_tz2_date_time,&loc_date_time,sizeof(date_time_t));
			}
			
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kvamd_tz3",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kvamd_tz3_date_time,&loc_date_time,sizeof(date_time_t));
			}
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kvamd_tz4",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kvamd_tz4_date_time,&loc_date_time,sizeof(date_time_t));
			}
			
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kvamd_tz5",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kvamd_tz5_date_time,&loc_date_time,sizeof(date_time_t));
			}
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kvamd_tz6",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kvamd_tz6_date_time,&loc_date_time,sizeof(date_time_t));
			}
			
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kvamd_tz7",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
				memcpy(&g_bill_val_info.kvamd_tz7_date_time,&loc_date_time,sizeof(date_time_t));
			}
			else if( (memcmp(billing_param_det[bill_dt_idx].param_name,"kvamd_tz8",strlen(billing_param_det[bill_dt_idx].param_name))) == 0)
			{
...
int32_t store_bill_val(uint8_t dp_index, uint8_t index, float recv_flt_val)
{
	...
	for(idx=0; idx<gen_bill_param_det.tot_num_val_obis; idx++)
	{
		if( (memcmp(gen_bill_param_det.val_obis[index],billing_param_det[idx].obis_code,6)) == 0)
		{
/* 			printf("--->>>>Param Obis and Val Obis matched:: Index : %d Idx : %d g_ls_entry_idx : %d recv_flt_val : %0.5f\n",
			...
			if( (memcmp(billing_param_det[idx].param_name,"sys_pf",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwh",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwh_tz1",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwh_tz2",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwh_tz3",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwh_tz4",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwh_tz5",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwh_tz6",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwh_tz7",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwh_tz8",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvarh_lag",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvarh_lead",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvah",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvah_tz1",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvah_tz2",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvah_tz3",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvah_tz4",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvah_tz5",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvah_tz6",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvah_tz7",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvah_tz8",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwmd",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwmd_tz1",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwmd_tz2",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwmd_tz3",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwmd_tz4",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwmd_tz5",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwmd_tz6",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwmd_tz7",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kwmd_tz8",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			}else if( (memcmp(billing_param_det[idx].param_name,"kvamd",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvamd_tz1",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvamd_tz2",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvamd_tz3",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvamd_tz4",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvamd_tz5",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvamd_tz6",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvamd_tz7",strlen(billing_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(billing_param_det[idx].param_name,"kvamd_tz8",strlen(billing_param_det[idx].param_name))) == 0)
			{
...
int32_t get_billing_obis_code_det(uint8_t comm_fd, uint32_t dlms_met_addr, uint8_t met_addr_size,gen_params_det_t *recv_gen_billing_param_det)
{
	...
	if(get_gen_val_obis(comm_fd,dlms_met_addr,met_addr_size, BILL_VAL_OBIS_TYPE,BILL_VAL_INT_CLASS,obis,6,BILL_VAL_ARR_NO)<0)
	{
	...
	if(get_gen_scalar_obis(comm_fd,dlms_met_addr,met_addr_size, BILL_SCALER_OBIS_TYPE,BILL_SCALAR_INT_CLASS,obis,6,BILL_SCARAR_ARR_NO)<0)
	{
	...
	if(get_gen_scalar_val(comm_fd,dlms_met_addr,met_addr_size, BILL_SCALER_VALUE_TYPE,BILL_SCALAR_VAL_INT_CLASS,obis,6,BILL_SCALAR_VAL_ARR_NO)<0)
	{
		dbg_log(INFORM,"%-20s : failed to get inst val obis code\n",fun_name);
		return RET_VAL_OBIS_INST_FAIL;
	}
...
int32_t proc_billing_value( uint8_t* msg, uint32_t len)
{
	...
	if(g_first_time_resp == 1)
	{
		...
		fun_name,gen_dp_param_det.tot_num_value,g_num_ls_param);
...
********************************************************************************************************/
int32_t get_dp_obis_code_det(uint8_t comm_fd, uint32_t dlms_met_addr, uint8_t met_addr_size,gen_params_det_t *recv_gen_daily_prof_param_det)
{
	...
	if(get_gen_val_obis(comm_fd,dlms_met_addr,met_addr_size, DAILY_VAL_OBIS_TYPE,DP_VAL_INT_CLASS,val_obis,6,DP_VAL_ATTR_NO)<0)
	{
		dbg_log(INFORM,"%-20s : failed to get daily profile val obis code\n",fun_name);
		return RET_VAL_OBIS_INST_FAIL;
	}
	...
	if(get_gen_scalar_obis(comm_fd,dlms_met_addr,met_addr_size, DAILY_SCALAR_OBIS_TYPE,DP_SCALAR_INT_CLASS,val_obis,6,DP_SCALAR_ATTR_NO)<0)
	{
		dbg_log(INFORM,"%-20s : failed to get inst val obis code\n",fun_name);
		return RET_VAL_OBIS_INST_FAIL;
	}
	...
	if(get_gen_scalar_val(comm_fd,dlms_met_addr,met_addr_size, DAILY_SCALAR_VALUE_TYPE,DP_SCALAR_VAL_INT_CLASS,val_obis,6,DP_SCALAR_VAL_ATTR_NO)<0)
	{
		dbg_log(INFORM,"%-20s : failed to get inst val obis code\n",fun_name);
		return RET_VAL_OBIS_INST_FAIL;
	}
...
int32_t store_dp_date_time(uint8_t dp_index, uint8_t index)
{
	...
	if(memcmp(gen_dp_param_det.val_obis[index],g_date_time_obis,6)==0)
	{
		...
		printf("Storing date for g_dp_entry_idx : %d -->>> %d_%d %02d:%02d \n",		g_dp_entry_idx,
...
int32_t store_dp_val(uint8_t dp_index, uint8_t index, float recv_flt_val)
{
	...
	for(idx=0; idx<gen_dp_param_det.tot_num_val_obis; idx++)
	{
		if( (memcmp(gen_dp_param_det.val_obis[index],daily_profile_param_det[idx].obis_code,6)) == 0)
		{
/* 			printf("--->>>>Param Obis and Val Obis matched:: Index : %d Idx : %d g_ls_entry_idx : %d recv_flt_val : %0.5f\n",
			index,idx,g_ls_entry_idx,recv_flt_val); */
			
			if( (memcmp(daily_profile_param_det[idx].param_name,"kvah_imp",strlen(daily_profile_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(daily_profile_param_det[idx].param_name,"kvah_exp",strlen(daily_profile_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(daily_profile_param_det[idx].param_name,"react_enhi",strlen(daily_profile_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(daily_profile_param_det[idx].param_name,"react_enlo",strlen(daily_profile_param_det[idx].param_name))) == 0)
			{
			...
			else if((memcmp(daily_profile_param_det[idx].param_name,"kvarh_q1",strlen(daily_profile_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(daily_profile_param_det[idx].param_name,"kvarh_q2",strlen(daily_profile_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(daily_profile_param_det[idx].param_name,"kwh_imp",strlen(daily_profile_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(daily_profile_param_det[idx].param_name,"kwh_exp",strlen(daily_profile_param_det[idx].param_name))) == 0)
			{
			...
			else if((memcmp(daily_profile_param_det[idx].param_name,"kvarh_q3",strlen(daily_profile_param_det[idx].param_name))) == 0)
			{
			...
			else if((memcmp(daily_profile_param_det[idx].param_name,"kvarh_q4",strlen(daily_profile_param_det[idx].param_name))) == 0)
			{
...
int32_t save_dp_data_file(void)
{
	...
	sprintf(curr_ls_file_path,"%s/dp_%02d_%04d.txt",
	g_ls_data_dir_path,
	...
	dbg_log(REPORT,"%-20s : Total num of mid_night data available : %d \n",fun_name,g_dp_entry_idx);
...
int32_t get_daily_profile_value(meter_comm_params_t*meter_comm_params, uint8_t dp_all)
{
	...
	if(dp_all==1)
	{
		if(send_get_request(comm_fd, dlms_met_addr, met_addr_size,DP_DATA_VAL_INT_CLASS, obis, 6, DP_DATA_VAL_ATTR_NO)<0)
		{
			dbg_log(REPORT,"%-20s : failed to get daily profile  value info\n",fun_name);
			return -1;
		}
	...
	else
	{
		...
		if(send_blk_profile_request(comm_fd, dlms_met_addr, met_addr_size, DP_DATA_VAL_INT_CLASS, obis, 6, DP_DATA_VAL_ATTR_NO)<0)
		{
...
int32_t store_event_det_file(uint8_t event_class)
{
	...
	memset(curr_ls_file_path,0,sizeof(curr_ls_file_path));
	sprintf(curr_ls_file_path,"%s/event.txt",g_ls_data_dir_path);
...
int32_t get_num_event_entries(uint8_t comm_fd, uint32_t dlms_met_addr, uint8_t met_addr_size, uint8_t* obis)
{
	...
	if(send_get_request(comm_fd,dlms_met_addr,met_addr_size, EVENT_ENTRY_INT_CLASS, obis, 6, EVENT_ENTRY_ATTR_NO)<0)
	{
		dbg_log(REPORT,"%-20s : failed to get event entry data info\n",fun_name);
		return -1;
	}
...
int32_t store_event_val( uint8_t event_class, uint8_t index, float recv_flt_val)
{
	...
	for(idx=0; idx<gen_event_param_det.tot_num_val_obis; idx++)
	{
		if( (memcmp(gen_event_param_det.val_obis[index], event_param_det[idx].obis_code, 6)) == 0)
		{
			if( (memcmp(event_param_det[idx].param_name,"cur_ir",strlen(event_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(event_param_det[idx].param_name,"cur_iy",strlen(event_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(event_param_det[idx].param_name,"cur_ib",strlen(event_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(event_param_det[idx].param_name,"volt_r",strlen(event_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(event_param_det[idx].param_name,"volt_y",strlen(event_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(event_param_det[idx].param_name,"volt_b",strlen(event_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(event_param_det[idx].param_name,"pf_r",strlen(event_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(event_param_det[idx].param_name,"pf_y",strlen(event_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(event_param_det[idx].param_name,"pf_b",strlen(event_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(event_param_det[idx].param_name,"kwh",strlen(event_param_det[idx].param_name))) == 0)
			{
			...
			else if( (memcmp(event_param_det[idx].param_name,"event_code",strlen(event_param_det[idx].param_name))) == 0)
			{
...
int32_t get_event_class_data(meter_comm_params_t *meter_comm_params, uint8_t event_class, uint8_t read_all_event_flag)
{
	...
	if(get_num_event_entries(comm_fd,dlms_met_addr,met_addr_size,obis)<0)
	{
	...
	if(send_get_event_request(comm_fd,dlms_met_addr,met_addr_size,EVENT_DATA_VAL_INT_CLASS, obis, 6, EVENT_DATA_VAL_ATTR_NO,read_all_event_flag)<0)
	{
...
int8_t get_event_obis_code_det(uint8_t comm_fd, uint32_t dlms_met_addr, uint8_t met_addr_size,gen_params_det_t*recv_gen_ls_param_det)
{
	...
	if(get_gen_val_obis(comm_fd, dlms_met_addr, met_addr_size, EVENT_VALUE_OBIS_TYPE,EVENT_VAL_INT_CLASS,val_obis,6,EVENT_VAL_ATTR_NO)<0)
	{
	...
	if(get_gen_scalar_obis(comm_fd, dlms_met_addr, met_addr_size, EVENT_SCALER_OBIS_TYPE,EVENT_SCALAR_INT_CLASS,val_obis,6,EVENT_SCALAR_ATTR_NO)<0)
	{
	...
	if(get_gen_scalar_val(comm_fd, dlms_met_addr, met_addr_size, EVENT_SCALER_VALUE_TYPE,EVENT_SCALAR_VAL_INT_CLASS,val_obis,6,EVENT_SCALAR_VAL_ATTR_NO)<0)
	{
...
{
	if(get_int_blk_period(comm_fd, dlms_met_addr, met_addr_size)<0)
		return RET_VAL_OBIS_LS_FAIL;
	...
	if(get_gen_val_obis(comm_fd, dlms_met_addr, met_addr_size, BLOCK_VAL_OBIS_TYPE,LS_VAL_INT_CLASS,val_obis,6,LS_VAL_ATTR_NO)<0)
	{
		dbg_log(INFORM,"%-20s : failed to get inst val obis code\n",fun_name);
		return RET_VAL_OBIS_LS_FAIL;
	}
	...
	if(get_gen_scalar_obis(comm_fd, dlms_met_addr, met_addr_size, BLOCK_SCALER_OBIS_TYPE,LS_SCALAR_INT_CLASS,val_obis,6,LS_SCALAR_ATTR_NO)<0)
	{
		dbg_log(INFORM,"%-20s : failed to get inst val obis code\n",fun_name);
		return RET_VAL_OBIS_LS_FAIL;
	}
	...
	if(get_gen_scalar_val(comm_fd, dlms_met_addr, met_addr_size, BLOCK_SCALER_VALUE_TYPE,LS_SCALAR_VAL_INT_CLASS,val_obis,6,LS_SCALAR_VAL_ATTR_NO)<0)
	{
		dbg_log(INFORM,"%-20s : failed to get inst val obis code\n",fun_name);
		return RET_VAL_OBIS_LS_FAIL;
	}
...
int32_t read_ls_data(uint8_t comm_fd, uint32_t dlms_met_addr, uint8_t met_addr_size)
{
	...
	if(send_blk_profile_request(comm_fd, dlms_met_addr, met_addr_size, LS_DATA_VAL_INT_CLASS, obis, 6, LS_DATA_VAL_ATTR_NO)<0)
	{
	...
	while(g_rr_frame || g_get_nxt_blk)
	{
		...
		if(temp_nxt_blk_flag)
		{
			//if(send_get_next_blk(midx, g_get_nxt_blk_val)<0)
			uint32_t *g_block_num_val = (uint32_t *)g_block_num_det;
			if(send_get_next_blk(comm_fd, dlms_met_addr, met_addr_size, *g_block_num_val)<0)
			{
				dbg_log(REPORT,"%-20s : failed to get inst scaler value next block frame\n",fun_name);
				return -1;
			}
...
int32_t recv_ls_blk_range_data(meter_comm_params_t *meter_comm_params, date_time_t st_date_time, date_time_t end_date_time)
{
	...
	if(read_ls_data(comm_fd, dlms_met_addr, met_addr_size)<0)
	{
...
********************************************************************************************************/
int32_t check_ls_file_avl(uint8_t midx, char* file_name)
{
	...
	{
		sprintf(time_entry,"%02d:%02d",23,(60-g_int_period_blk[midx]));
	}
...
int32_t recv_ls_day_range_data(meter_comm_params_t *meter_comm_params,uint8_t last_num_days_read)
{
	...
	for(idx=0; idx<last_num_days_read; idx++)
	{
		...
		else
		{
			...
			g_end_date_time.hour = 24;
			g_end_date_time.minute = 0;
			g_end_date_time.second = 0;
		}
		...
		if(check_ls_file_avl(midx,time_str)==1)
		{
...
int32_t get_int_blk_period(uint8_t comm_fd, uint32_t dlms_met_addr, uint8_t met_addr_size)
{
	...
	if(send_get_request(comm_fd, dlms_met_addr, met_addr_size, LS_BLK_INT_PER_INT_CLASS, obis, 6, LS_BLK_INT_PER_ATTR_NO)<0)
	{
...
/* 		loc_idx=25+OFFSET;
		{
			gen_ls_param_det.tot_num_value = msg[loc_idx-1];
...
int32_t send_blk_profile_request( uint8_t comm_fd, uint32_t dlms_met_addr, uint8_t met_addr_size,uint16_t int_class, uint8_t*obis_code, uint8_t obis_len, uint16_t attr_no)
{
	...
	switch(met_addr_size)
	{
		case 1:
			g_send_buff[idx++] = dlms_met_addr=3;
		break;

		case 2:
			g_send_buff[idx++] = 0x02;
			g_send_buff[idx++] = ((dlms_met_addr<<1)|0X01);
		break;

		case 4:
			g_send_buff[idx++] = 0x00;
			g_send_buff[idx++] = 0x02;
			g_send_buff[idx++] = (((dlms_met_addr>>7)<<1)&0XFF);
			g_send_buff[idx++] = ((dlms_met_addr<<1)|0X01);
		break;
	...
	send_fun_ret = send_msg_meter(comm_fd, g_send_buff, idx);
...
int32_t save_ls_data_file(void)
{
	...
	if(g_block_val_info.date_time.day==0)
	{
	...
	if((g_block_val_info.date_time.hour==0)&&
		(g_block_val_info.date_time.minute==0))
	{
		dbg_log(REPORT,"%-20s : g_meter_mfg_type : %d , No LS data flag status : %d .This is 00:00 entry for Curr file_name : %s\n",
		fun_name,g_meter_mfg_type,g_no_ls_data_avl_flag,curr_ls_file_name);
		
		if(g_meter_mfg_type==LNT_METER_MFG_TYPE)
		{
			if(g_no_ls_data_avl_flag==1)
			{
				dbg_log(REPORT,"%-20s : >>>>This entry no need to store in prev day file\n",fun_name);
			...
			st_time.tm_mday = g_block_val_info.date_time.day;
			st_time.tm_mon =  g_block_val_info.date_time.month - 1;
			st_time.tm_year = g_block_val_info.date_time.year - 1900;
			st_time.tm_hour = g_block_val_info.date_time.hour;
			st_time.tm_min = g_block_val_info.date_time.minute;
			st_time.tm_sec = g_block_val_info.date_time.second;
			
			time_of_day = mktime(&st_time);
			time_of_day -= (24*60*60);
			localtime_r(&time_of_day,&time_stamp);

			g_block_val_info.date_time.hour=24;
			g_block_val_info.date_time.minute=0;

			char temp_buff[32];
			memset(g_last_entry_buff,0,sizeof(g_last_entry_buff));
			memset(temp_buff,0,sizeof(temp_buff));
			
			sprintf(temp_buff,"%02d:%02d\t",g_block_val_info.date_time.hour,g_block_val_info.date_time.minute);
			strcat(g_last_entry_buff,temp_buff);
			memset(temp_buff,0,sizeof(temp_buff));
	
			p_flt_ptr=0.0;
			memcpy(&p_flt_ptr,&g_block_val_info.kwh_imp.param_value,4);
			sprintf(temp_buff,"%0.5f\t",p_flt_ptr);
			strcat(g_last_entry_buff,temp_buff);
			memset(temp_buff,0,sizeof(temp_buff));

			p_flt_ptr=0.0;
			memcpy(&p_flt_ptr,&g_block_val_info.kvah_imp.param_value,4);
			sprintf(temp_buff,"%0.5f\t",p_flt_ptr);
			strcat(g_last_entry_buff,temp_buff);
			memset(temp_buff,0,sizeof(temp_buff));
			...
			p_flt_ptr=0.0;
			memcpy(&p_flt_ptr,&g_block_val_info.kvah_exp.param_value,4);
			sprintf(temp_buff,"%0.5f\t",p_flt_ptr);
			strcat(g_last_entry_buff,temp_buff);
			memset(temp_buff,0,sizeof(temp_buff));
			
			p_flt_ptr=0.0;
			memcpy(&p_flt_ptr,&g_block_val_info.kvarh_lead.param_value,4);
			sprintf(temp_buff,"%0.5f\t",p_flt_ptr);
			strcat(g_last_entry_buff,temp_buff);
			memset(temp_buff,0,sizeof(temp_buff));
			
			p_flt_ptr=0.0;
			memcpy(&p_flt_ptr,&g_block_val_info.kvarh_lag.param_value,4);
			sprintf(temp_buff,"%0.5f\t",p_flt_ptr);
			strcat(g_last_entry_buff,temp_buff);
			memset(temp_buff,0,sizeof(temp_buff));
			
			p_flt_ptr=0.0;
			memcpy(&p_flt_ptr,&g_block_val_info.cur_ir.param_value,4);
			sprintf(temp_buff,"%0.5f\t",p_flt_ptr);
			strcat(g_last_entry_buff,temp_buff);
			memset(temp_buff,0,sizeof(temp_buff));
			...
			sprintf(temp_buff,"%0.5f\n",p_flt_ptr);
			strcat(g_last_entry_buff,temp_buff);
			
			//dbg_log(REPORT,"%-20s : Previous day load survey file_name : %s\n",fun_name,curr_ls_file_name);	
	...
	memset(time_str,0,sizeof(time_str));
	sprintf(time_str,"%02d:%02d",g_block_val_info.date_time.hour,g_block_val_info.date_time.minute);
	...
	if(avl_file == 0)
	{
		...
		fprintf(p_ls_file_ptr,"%d.%d.%d.%d.%d.%d\t%d.%d.%d.%d.%d.%d\t\%d.%d.%d.%d.%d.%d\t%d.%d.%d.%d.%d.%d\t%d.%d.%d.%d.%d.%d\t%d.%d.%d.%d.%d.%d\t%d.%d.%d.%d.%d.%d\t%d.%d.%d.%d.%d.%d\t%d.%d.%d.%d.%d.%d\t%d.%d.%d.%d.%d.%d\t%d.%d.%d.%d.%d.%d\t%d.%d.%d.%d.%d.%d\t%d.%d.%d.%d.%d.%d\t%d.%d.%d.%d.%d.%d\t\n",
			g_date_time_obis[0],g_date_time_obis[1],g_date_time_obis[2],g_date_time_obis[3],
			g_date_time_obis[4],g_date_time_obis[5],
			...
			g_block_val_info.kvah_imp.param_obis_code[0],g_block_val_info.kvah_imp.param_obis_code[1],
			g_block_val_info.kvah_imp.param_obis_code[2],g_block_val_info.kvah_imp.param_obis_code[3],
			g_block_val_info.kvah_imp.param_obis_code[4],g_block_val_info.kvah_imp.param_obis_code[5],
			...
			g_block_val_info.kvah_exp.param_obis_code[0],g_block_val_info.kvah_exp.param_obis_code[1],
			g_block_val_info.kvah_exp.param_obis_code[2],g_block_val_info.kvah_exp.param_obis_code[3],
			g_block_val_info.kvah_exp.param_obis_code[4],g_block_val_info.kvah_exp.param_obis_code[5],
			
			g_block_val_info.kvarh_lead.param_obis_code[0],g_block_val_info.kvarh_lead.param_obis_code[1],
			g_block_val_info.kvarh_lead.param_obis_code[2],g_block_val_info.kvarh_lead.param_obis_code[3],
			g_block_val_info.kvarh_lead.param_obis_code[4],g_block_val_info.kvarh_lead.param_obis_code[5],
			
			g_block_val_info.kvarh_lag.param_obis_code[0],g_block_val_info.kvarh_lag.param_obis_code[1],
			g_block_val_info.kvarh_lag.param_obis_code[2],g_block_val_info.kvarh_lag.param_obis_code[3],
			g_block_val_info.kvarh_lag.param_obis_code[4],g_block_val_info.kvarh_lag.param_obis_code[5],
			
			g_block_val_info.cur_ir.param_obis_code[0],g_block_val_info.cur_ir.param_obis_code[1],
			g_block_val_info.cur_ir.param_obis_code[2],g_block_val_info.cur_ir.param_obis_code[3],
			g_block_val_info.cur_ir.param_obis_code[4],g_block_val_info.cur_ir.param_obis_code[5],
	...
	fun_name,g_block_val_info.date_time.hour,
	g_block_val_info.date_time.minute);
	
	fprintf(p_ls_file_ptr,"%02d:%02d\t",g_block_val_info.date_time.hour,g_block_val_info.date_time.minute);
	
	p_flt_ptr=0.0;
	memcpy(&p_flt_ptr,&g_block_val_info.kwh_imp.param_value,4);
	fprintf(p_ls_file_ptr,"%0.5f\t",p_flt_ptr);
	...
	if(g_secure_met_flag==1)
	{
		dbg_log(INFORM,"%-20s : Meter storing order is FIFO need to sort the LS file\n",fun_name);
...
int32_t store_ls_val( uint8_t ls_idx, uint8_t index, float recv_flt_val)
{
	...
	for(idx=0;idx<gen_ls_param_det.tot_num_val_obis;idx++)
	{
		if( (memcmp(gen_ls_param_det.val_obis[index],ls_param_det[idx].obis_code,6)) == 0)
		{
...
int32_t get_inst_val(uint8_t comm_fd, uint32_t dlms_met_addr, uint8_t met_addr_size, inst_val_info_t *recv_inst_data_val)
{
	...
	if(send_get_request(comm_fd, dlms_met_addr, met_addr_size, INST_DATA_VAL_INT_CLASS, obis, 6, INST_DATA_VAL_ATTR_NO)<0)
	{
		dbg_log(REPORT,"%-20s : failed to get inst scaler obis info\n",fun_name);
		return -1;
	}
...
int32_t store_inst_val(uint8_t index, float recv_flt_val)
{
	...
	for(idx=0; idx<gen_inst_param_det.tot_num_value; idx++)
	{
		if( (memcmp(gen_inst_param_det.val_obis[index], inst_param_det[idx].obis_code, 6)) == 0)
		{
...
int32_t get_inst_obis_code_det(uint8_t comm_fd, uint32_t dlms_met_addr, uint8_t met_addr_size,gen_params_det_t *recv_gen_inst_param_det)
{
	...
	if(get_gen_val_obis(comm_fd,dlms_met_addr,met_addr_size, INST_VAL_OBIS_TYPE,INST_VAL_INT_CLASS,val_obis,6,INST_VAL_ATTR_NO)<0)
	{
		dbg_log(INFORM,"%-20s : failed to get inst val obis code\n",fun_name);
		return RET_VAL_OBIS_INST_FAIL;
	}
	...
	if(get_gen_scalar_obis(comm_fd,dlms_met_addr,met_addr_size, INST_SCALE_OBIS_TYPE,INST_SCALAR_INT_CLASS,val_obis,6,INST_SCALAR_ATTR_NO)<0)
	{
		dbg_log(INFORM,"%-20s : failed to get inst val obis code\n",fun_name);
		return RET_VAL_OBIS_INST_FAIL;
	}
	...
	if(get_gen_scalar_val(comm_fd,dlms_met_addr,met_addr_size, INST_SCALE_VAL_TYPE,INST_SCALAR_VAL_INT_CLASS,val_obis,6,INST_SCALAR_VAL_ATTR_NO)<0)
	{
		dbg_log(INFORM,"%-20s : failed to get inst val obis code\n",fun_name);
		return RET_VAL_OBIS_INST_FAIL;
	}
...
int32_t get_curr_date_time(uint8_t comm_fd, uint32_t dlms_met_addr, uint8_t met_addr_size)
{
	...
	if(send_get_request(comm_fd, dlms_met_addr, met_addr_size,DATE_TIME_INT_CLASS,obis,6,DATE_TIME_ATTR_NO)<0)
	{
...
int32_t send_aarq(uint8_t comm_fd, uint32_t dlms_met_addr, uint8_t met_addr_size, char*meter_pass)
{
	...
	g_send_buff[idx++] = 46 + strlen(meter_pass);
	...
	g_send_buff[idx++] = 2 + strlen(meter_pass);
	g_send_buff[idx++] = 0x80;
	g_send_buff[idx++] = strlen(meter_pass);

	memcpy((void *)&g_send_buff[idx],(const void*)meter_pass,strlen(meter_pass));
	idx += strlen(meter_pass);
...
int8_t get_nameplate_info(uint8_t comm_fd, uint32_t dlms_met_addr, uint8_t met_addr_size, obis_name_plate_info_t *np_params_obis_val_info)
{
	...
	for(idx=0; idx<6; idx++)
	{
		...
		if(send_get_request(comm_fd,dlms_met_addr,met_addr_size,NP_INT_CLASS, name_plate_obis[idx], 6, NP_ATTR_NO)<0)
		{
	...
	if( get_event_entry_order(comm_fd,dlms_met_addr,met_addr_size)<0)
	{
...
int32_t send_msg_meter(uint8_t g_serial_fd, uint8_t* msg, int32_t len)
{
	...
	for(retry=0; retry<3; retry++)
	{
		...
		else
		{
			...
			ser_read_ret = read_ser_port(g_serial_fd, g_recv_buff, 2);
			if(ser_read_ret<0)
			{
				//g_met_status=0;
				dbg_log(REPORT,"%-20s : Read serial failed, Retry Val : %d\n",fun_name,retry+1);
				
				//(midx,"%-16s : Read serial failed, Retry Val : %d",g_curr_meter_ser_info,retry+1);
				
				//memset(&g_last_met_on_time_info,0,sizeof(date_time_t));
				//memcpy(&g_last_met_on_time_info,&meter_date_time,sizeof(date_time_t));
				usleep(500000);
				continue;
			}
			else
			{
				...
				if(proc_read_resp(g_recv_buff, ser_read_ret)<0)
				{
...
int32_t proc_read_resp(uint8_t* msg, int32_t len)
{
	...
	switch(g_query_type)
	{
		case AARQ_TYPE:
			...
			if(msg[28+OFFSET]!=0)
			{
				dbg_log(REPORT,"%-20s : AARQ Response failed\n",fun_name);
...
int32_t validate_met_resp(uint8_t* msg, int32_t len )
{
	...
	if( loc_fcs != tmp )
	{
		dbg_log(REPORT,"%-20s : Header FCS Not Matched\n",fun_name);
	...
	if( loc_fcs != tmp )
	{
		dbg_log(REPORT,"%-20s : Final FCS Not Matched\n",fun_name);
